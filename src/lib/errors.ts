...
export enum AppErrorCode {
  ...
  PASSWORD_CONFIRMATION_REQUIRED = 'ERROR_PASSWORD_CONFIRMATION_REQUIRED',
  ...
  // 5. Błędy Uniwersytetu i Zaproszeń
  UNIVERSITY_NOT_FOUND = 'ERROR_UNIVERSITY_NOT_FOUND',
  INVITATION_NOT_FOUND = 'ERROR_INVITATION_NOT_FOUND',
  INVITATION_EXPIRED = 'ERROR_INVITATION_EXPIRED',
  INVITATION_ALREADY_ACCEPTED = 'ERROR_INVITATION_ALREADY_ACCEPTED',
  SLUG_ALREADY_EXISTS = 'ERROR_SLUG_ALREADY_EXISTS',
}
