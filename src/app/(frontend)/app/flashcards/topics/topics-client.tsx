...
import { ArrowLeft, Plus, MoreVertical, Trash2, Eye, Pencil } from 'lucide-react';
...
export default function TopicsClient({ topics: initialTopics, flashcards: initialFlashcards }: TopicsClientProps) {
                  ...
                  <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => setViewTopicId(topic.id)}>
                          <Eye className="mr-2 h-4 w-4" /> {t('view_flashcards')}
                        </DropdownMenuItem>
