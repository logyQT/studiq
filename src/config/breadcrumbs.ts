...
export const BREADCRUMB_ROUTES: Record<string, BreadcrumbRouteEntry> = {
  ...
  '/app/flashcards/deck/[deckId]': { labelKey: 'decks_title', namespace: 'AppFlashcardsPage', href: '/app/flashcards/decks' },
  ...
  '/edu/flashcards/deck/[deckId]': { labelKey: 'decks_title', namespace: 'EduFlashcardsPage', href: '/edu/flashcards/decks' },
  ...
  '/edu/flashcards/stats/difficulty/[bucket]': { labelKey: 'stats_title', namespace: 'EduFlashcardsPage' },
