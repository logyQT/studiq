...
describe('get_accessible_questions RPC', () => {
  let orgId: string;
  ...
  beforeEach(async () => {
    // Clean up questions from previous test runs to prevent data leakage
