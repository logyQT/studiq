-- ==========================================
-- Replaces handle_new_organization trigger func
-- to include display_name in role INSERTs.
-- The original migration was edited in-place,
-- so this new migration ensures the DB is updated.
-- ==========================================
