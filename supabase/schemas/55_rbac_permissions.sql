...
--        'university' → user can act on resources within their organization
--        'any'       → user can act on any resource globally
--        'granted'   → boolean feature gate (user has access, no resource scoping)
-- ==========================================
...
CREATE TABLE public.role_permissions (
  ...
  scope         text NOT NULL CHECK (scope IN ('own', 'university', 'any', 'granted')),
